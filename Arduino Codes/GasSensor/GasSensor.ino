...
// Downloaded from: https://circuits.io/circuits/5096044-esp8266
...
void setup() {
  ...
  String url = "/publish/pub-c-52dfaf38-9202-447f-a5c4-4fffdd0fdeac/sub-c-09f86e3c-2e1e-11e7-97de-0619f8945a4f/0/GetDevices/0/{\"Sensors\":{\"Kitchen\":{\"Gas\":\"KitchenGas\"}}}";
    Serial.println(url);
...
void loop() {
  ...
  if(sensorValue>350){
    ...
    String url = "/publish/pub-c-52dfaf38-9202-447f-a5c4-4fffdd0fdeac/sub-c-09f86e3c-2e1e-11e7-97de-0619f8945a4f/0/GasSensor/0/\"Alert\"";
    Serial.println(url);
    ...
    delay(2000); // wait 10 seconds before updating
  }
}
