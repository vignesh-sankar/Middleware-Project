...
void setup() {
  ...
  String url = "/publish/pub-c-52dfaf38-9202-447f-a5c4-4fffdd0fdeac/sub-c-09f86e3c-2e1e-11e7-97de-0619f8945a4f/0/GetDevices/0/{\"Sensors\":{\"Room1\":{\"Motion\":\"Room1Motion\"}}}";
    Serial.println(url);
...
void loop() {
  ...
  if(distance<120){
    ...
    String url = "/publish/pub-c-52dfaf38-9202-447f-a5c4-4fffdd0fdeac/sub-c-09f86e3c-2e1e-11e7-97de-0619f8945a4f/0/Sensors/0/\"Room1:Light1:"+state+"\"";
    Serial.println(url);
